  ...
  <section class="form-section">
    <div class="field-grid">
      <el-form-item label="成果标题" prop="title" class="field-full">
        <el-input v-model="form.title" maxlength="80" placeholder="请输入" />
      </el-form-item>

      <el-form-item label="所属教育局" prop="bureauId">
        <el-select v-model="form.bureauId" placeholder="请选择">
          <el-option
      ...
      <el-form-item label="等级" prop="levelId">
        <el-select v-model="form.levelId" placeholder="请选择" :disabled="!form.type">
          <el-option
